      ...
      <div className="p-4 sm:p-5 border-b border-gray-200 dark:border-[#1F2937] bg-white/90 dark:bg-[#0A0A0B]/90 backdrop-blur-md sticky top-0 z-10">
        <div className="flex items-center justify-between gap-2 mb-2">
          <div className="flex items-center gap-2">
            ...
            {panels.length > 0 && (
              <span className="px-2 py-0.5 rounded text-[10px] font-mono font-medium bg-blue-50 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800/50">
                {panels.length} READY
              </span>
            )}
          </div>
        ...
        {panels.length > 0 ? (
          <div className="grid grid-cols-3 gap-1.5 mt-3">
            <button
              ...
              className="flex items-center justify-center gap-1 py-2 px-2 rounded text-xs font-medium bg-blue-600 hover:bg-blue-700 text-white shadow-sm transition-all active:scale-[0.98]"
              title="Download ZIP archive with all panels"
            >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2 text-[11px] font-mono text-gray-500 dark:text-gray-400 mt-1">
                          <span>
                            {panel.outputWidth} × {panel.outputHeight}
                          </span>
                          <span>•</span>
